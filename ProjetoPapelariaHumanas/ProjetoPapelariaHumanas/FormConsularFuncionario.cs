...
{
    public partial class FormConsularFuncionario : Form
    {
        public FormConsularFuncionario()
        {
            InitializeComponent();
        }
        ...
        {
            combo_pesquisa.Items.Add("CPF");
            combo_pesquisa.Items.Add("Nome");
            combo_pesquisa.Items.Add("Sexo");
            combo_pesquisa.Items.Add("Status");
            combo_pesquisa.Items.Add("Cargo");

            //Deixar a opção nome selecionada

            combo_pesquisa.SelectedItem = "Nome";
        ...
        private void combo_pesquisa_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //cpf
            if (combo_pesquisa.SelectedIndex == 0)
            {
            ...
            //Nome
            if (combo_pesquisa.SelectedIndex == 1)
            {
            ...
            //Sexo
            if (combo_pesquisa.SelectedIndex == 2)
            {
                box_nome_fun.Enabled = false;
                groupBoox_tipopesquisa.Enabled = false;
            ...
            //Status
            if (combo_pesquisa.SelectedIndex == 3)
            {
                box_nome_fun.Enabled = false;
                groupBoox_tipopesquisa.Enabled = false;
                groupBox_cargo.Enabled = false;
            ...
            //Cargo
            if (combo_pesquisa.SelectedIndex == 4)
            {
                box_nome_fun.Enabled = false;
                groupBoox_tipopesquisa.Enabled = false;
                groupBox_cpf.Enabled = false;
        ...
        private void bt_pesquisar_Click(object sender, EventArgs e)
        {
            ...
            string CONSULTA = combo_pesquisa.SelectedItem.ToString();
        ...
        private void dataGridView_funcionario_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (MessageBox.Show("Deseja alterar o Funcionário selecionado?", "Sistema Papelaria Humanas", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
