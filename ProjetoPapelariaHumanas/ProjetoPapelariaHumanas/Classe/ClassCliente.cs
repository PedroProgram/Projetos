...
namespace ProjetoPapelariaHumanas
{
    class ClassCliente
    {
        ...
        public DataTable ConsultaClienteNomeContemVenda(string nomecontem)
        {
            string query = "select codigo_cliente, nome, cpf FROM cliente WHERE status_cliente = 1 and nome like '%" + nomecontem + "%' ORDER by nome";
        ...
        {
            string query = "SELECT codigo_cliente, nome from cliente WHERE status_cliente = 1 order by nome ";
